    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6">
        ...
        */}
        <label
          htmlFor="logo-upload"
          className="mt-6 flex cursor-not-allowed flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-slate-200 bg-slate-50 px-6 py-10 text-center"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
