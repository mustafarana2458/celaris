  ...
  return (
    ...
    >
      {/* Mounted only while open, and remounted fresh on every open -- this is
          what actually resets the form between one Create and the next, or
          fully repopulates it when editing a different profile. The
          controlled state (line items, tax, discount, auto-send) lives
          inside RecurringProfileForm rather than here, since
          RecurringProfileModal itself never unmounts between opens. */}
      {open && (
