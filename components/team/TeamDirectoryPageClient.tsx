...
export function TeamDirectoryPageClient({ initialTeamMembers }: { initialTeamMembers: TeamMember[] }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <TeamMemberModal open={modalOpen} onClose={closeModal} member={editing} onSaved={handleSaved} />

      <DeleteTeamMemberDialog member={deleting} onClose={() => setDeleting(null)} onDeleted={handleDeleted} />
    </div>
  );
}
